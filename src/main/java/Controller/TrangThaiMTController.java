...
import Database.MayTinhDAO;
import Database.ThongTinSuDungDAO;
...
public class TrangThaiMTController implements Initializable {
    ...
    private void handleSaveAction(ActionEvent event) {
        ...
        DanhSachTKDAO taiKhoanDAO = new DanhSachTKDAO();
        try {
            List <TaiKhoan> lstTaiKhoan = new DanhSachTKDAO().getMainDanhSachTK();
